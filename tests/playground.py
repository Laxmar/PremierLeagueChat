...
async def main():
    ...
    message = HumanMessage(content="What is the squad of the Manchester?") 
    ...
    print(response)
    response = await agent.ask(HumanMessage(content="manchester united"))    
    print(response)
    response = await agent.ask(HumanMessage(content="squad of liverpool?"))    
